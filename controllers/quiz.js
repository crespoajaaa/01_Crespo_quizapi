...
// READ: menampilkan atau menagambil semua data quiz sesuai model dari database
exports.getAll = async(req, res) => {
    try {
        const quizzes = await Quiz.findAll()
        res.json({
            message: "Quizess retrieved succesfully.",
            data: quizzes,
        });
    }   catch (error) {
        res.status(500).json({
...
exports.update = async (req, res) => {
    ...
    try {
        ...
        res.json({
            message: "Quizess update succesfully.",
            data: quiz,
        });
    } catch (error) {
        res.status(500).json({
...
exports.getByCategoryId = async (req, res) => {
    ...
    res.json({
        message: `Quizess retrieved succesfully with categoryId=${id}.`,
        data: quizzes,
    });
}
...
exports.getByLevelId = async (req, res) => {
    ...
    res.json({
        message: `Quizess retrieved succesfully with levelId=${id}.`,
        data: quizzes,
    });
}